...
sys.path.append("/Volumes/ppm/PPM/NCAP_bids/Code/fmriprep")
...
os.chdir('/Volumes/ppm/PPM/NCAP_bids/Code/fmriprep')
...
atlas_dlabel = '/Volumes/ppm/PPM/NCAP_bids/Code/Gordon333_SeitzmanSubcortical.32k_fs_LR.dlabel.nii'
    ...
    for directory in dirs:
        if (directory == 'func') and ('xcp_d' not in root):
            ...
            for tsv in cur_confounds:
                ...
                regressed_32p_out = resampled_out.replace('.32k_fs_LR', '_regressed32P.32k_fs_LR')
                den_sl.regress_out_nuissance(regress_32p_txt_out, resampled_out, regressed_32p_out)
                ...
                regressed_32p_despike_out = resampled_out.replace('.32k_fs_LR',
                                                                  '_regressed32P_despiked.32k_fs_LR')
                den_sl.regress_out_nuissance(regress_32p_despike_txt_out,
                                             resampled_out, regressed_32p_despike_out)
